...
<div class="wrapper wrapper-content animated fadeInRight">
    ...
    <div class="ibox float-e-margins">
        <form action="<%=path %>/test/update.do" method="post" class="form-horizontal" role="form">
            <input type="hidden1" name="testId" value="${testEntity.testId }"/>
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input class="form-control" type="text"  name="testDate" value="<fmt:formatDate value="${testEntity.testDate}" pattern="yyyy-MM-dd"></fmt:formatDate>"/>
                    </div>
                </div>
            </fieldset>
            <fieldset>
